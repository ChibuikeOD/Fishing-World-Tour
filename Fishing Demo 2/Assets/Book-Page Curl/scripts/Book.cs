...
public class Book : MonoBehaviour {
    ...
    void Start()
    {
        ...
        //Set new pages to the fish the player has caught
        for (int i = 0; i < GameManager.Instance.getSpecies(); i++)
        {
            FishInfo newFish = GameManager.Instance.returnFish(i);
            newFish.Reset();
            bookPages[i] = newFish.journalPage;
        }
    }
